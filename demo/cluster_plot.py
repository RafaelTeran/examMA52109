...
def main(args: List[str]) -> None:
    ...
    for k in (2, 3, 4, 5):
        ...
        result = run_clustering(
            ...
            algorithm="kmeans",
            k = k, # First problem, k is intended to be 2,3,4,5, not 2,3,3,3
            standardise=True,
    ...
    # Second problem, silhouette_score is not computed
    # because it is not the given name in the metrics dict
